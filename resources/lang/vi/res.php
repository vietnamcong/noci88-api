...
return [
    ...
    'member' => [
        ...
        'index' => [
            ...
            'title_modify_top' => '4/5000 Phân phối các đại lý',
    ...
    'apis' => [
        ...
        'index' => [
            'top_title' => 'Cài đặt cấu hình API',
            ...
            'api_id' => 'API ID',
            'api_key' => 'API key',
            'company_key' => 'SBO company key',
            'bet_history_time' => 'Thời gian lấy lịch sử cược (Phút)',
    ...
    'api_game' => [
        ...
        'mobile_category' => [
            ...
            'key' => 'Nhận diện',
            'name' => 'Tên gọi',
            'game_category_name' => 'Tên danh mục',
            'game_category_type' => 'Loại trò chơi',
            'image_preview' => 'Hình ảnh',
            'status' => 'Trạng thái',
            'weight' => 'Thứ tự',
            'icon_before_category' => 'Biểu tượng (phía trước) danh mục',
            'icon_after_category' => 'Biểu tượng (phía sau) danh mục',
            'icon_before_upload' => 'Tải lên biểu tượng (phía trước)',
            'icon_after_upload' => 'Tải lên biểu tượng (phía sau)',
        ]
    ],

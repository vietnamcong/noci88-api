...
class AuthController extends MemberBaseController
{
    ...
    public function register(Request $request)
    {
        ...
        $this->validateRequest($data, [
            'name' => [
                'required', 'min:6', 'max:20', 'unique:members,name', 'regex:/^[a-zA-Z][a-zA-Z0-9]*$/'
            ],
        ...
        app(MemberLogService::class)->setIp($request->get('ip'))->memberLoginLogCreate('', $token, $time);

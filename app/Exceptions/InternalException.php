...
class InternalException extends Exception
{
     ...
     * @param int $code
     */
    public function __construct(string $message, string $msgForUser = 'Lỗi hệ thống nội bộ', int $code = 500)
    {
    ...
    public function render(Request $request)
    {
		...
		return response()->json(['messages' => responseMessage()['error'], 'error' => $this->msgForUser, 'code' => $this->code]); 
    }
}

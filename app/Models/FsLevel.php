...
class FsLevel extends Model
{
    ...
    public static $list_field = [
        'game_type' => ['name' => 'Loại trò chơi','type' => 'select','validate' => 'required_without','is_show' => true,'data' => 'platform.game_type'],
        'product_type' => ['name' => 'Loại trò chơi SBO','type' => 'select','validate' => 'required_with','is_show' => true,'data' => 'platform.product_type'],
        ...
        'quota' => ['name' => 'Số tiền đặt cược hợp lệ','type' => 'money','validate' => 'required','is_show' => true],
    ...
    const TYPE_SYSTEM = 1;
    const TYPE_MEMBER = 2;
    const TYPE_SABA_SYSTEM = 44;
    const TYPE_AFB_SYSTEM = 1015;
    const TYPE_BTI_SYSTEM = 1022;
